...
@section('content')
        ...
        <div class="admin_breadcrumbs">
            <ul class="breadcrumbs_list">
                ...
                <li class="breadcrumbs_item active">Edit Jump Out</li>
            </ul>
        </div>
                                ...
                                <form>
                                    <div class="module_add_row">
                                        ...
                                        <div class="module_add_row_input">
                                            <input type="text" placeholder="Enter name of Jump Out" id="campaign_name" value="{{ $module->name }}">
                                        </div>
                                    </div>
                                    <div class="module_add_row">
                                        <div class="question">
                                        ...
                                        <label for="conversions">
                                            <span>Приоритет отображения</span><input type="number" id="queue" placeholder="1" name="queue" value="{{ $module->priority }}" class="input_small"><span></span>
                                        </label>
                                    </div> 
                                </form>
                            </div>
                            ...
                            @if(isset($data['template']))
                                ...
                                @if(isset($data['template']))
                                    <div class="jump_out_create">
                                        <a href="/admin/domains/{{ $domain->id }}/jumpout/{{ $module->id }}/redactor" class="jump_out_create_link" id="moveToRedactor" data-type="edit">Edit Jump Out</a>
                                    </div>
                                @else
                                    <div class="jump_out_create">
