...
<head>
    ...
    @if(isset($pagination) && isset($pagination['current']) && $pagination['current'] > 1)
        <title>Trust Activity Blog - Page {{ $pagination['current'] }}</title>
    @else
        <title>Trust Activity Blog</title>
    @endif

    @if(isset($pagination) && isset($pagination['current']) && $pagination['current'] > 1)
        <meta name="description" content="Trust Activity Blog is for business with a focus on bringing you the latest marketing tips, strategies and best practices. Page {{ $pagination['current'] }}.">
    @else
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-4 col-md-5 col-sm-6 col-x-8 col-xs-9">
                <div class="logo_blog">
                    <a href="/blog" class="logo_blog_img"></a>
                </div>
                <div class="lang">
                ...
                <div class="col-lg-5 col-md-6 col-sm-6 col-x-5 col-xs-12">
                    <div class="copy_block">
                        ...
                        <p class="social_icon">
                            ...
                            <a href="https://instagram.com/trustactivity/" target="_blank" class="insta"></a>
