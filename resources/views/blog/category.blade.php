...
<head>
    ...
    @if(isset($current_category->title))
        <title>{{ $current_category->title }}</title>
    @else
        <title></title>
    @endif
    ...
    @if(isset($current_category->description))
                    ...
                    @for($i = 1; $i < count($articles); $i++)
                    	...
                    	@endif
	                        ...
	                        <div class="c-blog_item">
	                            ...
	                            <h2 class="title_blog title_blog_item"><a href="/blog/{{ $articles[0]->category($articles[0]->category_id)->url }}/{{ $articles[$i]->url }}">{{ $articles[$i]->h1 }}</a></h2>
